                ...
                <div id="leftcontainer">
                    ...
                    <section id="sidebar">
                        ...
                        if (isset($_POST['Enviar'])) {
                            ...
                            $num_coincidencias = preg_match_all($patron, $text, $matches);
            
                            $text_resaltado = preg_replace($patron, '<span style="background:#5fc9f6">$1</span>', $text);
                        ?>
                            <div id="sidebarwrap">
                                <h2>Resultado: <?php echo $num_coincidencias; ?> coincidencia(s) encontrada(s)</h2>
                                <p><?php echo nl2br($text_resaltado); ?></p>
                            </div>
                        <?php
                        }
                        ?>
                    ...
                    <article class="post">
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="form">
                            <p class="textfield">
                                ...
                                <input name="palabra" id="palabra" value="" size="22" tabindex="1" type="text" required />
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <input name="submit" id="submit" tabindex="5" type="image" src="images/submit.png" alt="Enviar" />
                            </p>
                            <div class="clear"></div>
                        </form>
                        <div class="clear"></div>
